...
const productData = [
  ...
  // monitors
  {
    ...
    stock: 30,
    category_id: 2,
    product_description: "38 inch 21: 9 Curved UltraWide QHD + (3840 x 1600) Nanio IPS Display, Thunderbolt 3, 1ms Response Time, 144Hz Refresh Rate, NVIDIA G - SYNC, AMD FreeSync",
  ...
  },
  {
    ...
    stock: 40,
    category_id: 2,
    product_description: "31.5 inch 4K UHD WLED LCD Monitor - 16:9'",
  ...
  },
  {
    ...
    stock: 40,
    category_id: 2,
    product_description: "27-inch 4K USB-C Monitor - UHD (3840 x 2160) Display, 60Hz Refresh Rate, 8MS Grey-to-Grey Response Time (Normal Mode), Built-in Dual 3W Speakers, 1.07 Billion Colors - Platinum Silver",
  ...
  },
  {
    ...
    stock: 40,
    category_id: 2,
    product_description: "27” WQHD (2560 x 1440) Monitor, 100% sRGB/Rec. 709 ΔE < 2, IPS, DisplayPort HDMI DVI-D Mini DP, Calman Verified, Anti-glare, Tilt Pivot Swivel Height Adjustable, Black",
  ...
  },
  {
    ...
    stock: 25,
    category_id: 3,
    product_description: "Wireless Over Ear Headphones.Active Noise Cancelling, Transparency Mode, Spatial Audio, Digital Crown for Volume Control. Bluetooth Headphones for iPhone",
  ...
  },
  {
    ...
    stock: 60,
    category_id: 4,
    product_description: "Rechargeable 2.4GHz Optical Vertical Mice: 3 Adjustable DPI 800 / 1200 / 1600 Levels 6 Buttons; for Laptop; PC; Computer; Desktop; Black",
